    ...
    private function update() {
        if ($this->access['rw'] >= $_SESSION['access']) {
            foreach ($this->engine->languages as $lang) {
                ...
                $params_arr['remember_me_' . $lang['name']]          = $_POST['remember_me_' . $lang['name']];
                ...
                $params_arr['login_success_' . $lang['name']]        = $_POST['login_success_' . $lang['name']];
                ...
                $params_arr['changes_applied_' . $lang['name']]      = $_POST['changes_applied_' . $lang['name']];

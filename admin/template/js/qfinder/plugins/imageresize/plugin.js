QFinder.addPlugin('imageresize', {
    ...
    uiReady: function (api) {
        ...
        var switchLockRatio = function (dialog, value) {
            ...
            if (dialog.lockRatio)
                ratioButton.removeClass('qf_btn_unlocked');
            else
                ratioButton.addClass('qf_btn_unlocked');

            return dialog.lockRatio;
        };

        QFinder.dialog.add('resizeDialog', function (api) {
            return {
                title: api.lang.Imageresize.dialogTitle.replace('%s', api.getSelectedFile().name),
                // TODO resizable : QFinder.DIALOG_RESIZE_BOTH
                minWidth: QFinder.env.webkit ? 290 : 390,
                minHeight: 230,
                onShow: function () {
                    var dialog = this,
                        thumbSmall = QFinder.config.imageresize_thumbSmall,
                        thumbMedium = QFinder.config.imageresize_thumbMedium,
                        thumbLarge = QFinder.config.imageresize_thumbLarge;
                    ...
                    var updateImgDimension = function (width, height) {
                        ...
                        QFinder.tools.setTimeout(function () {
                        ...
                        elements: [
                            {
                                ...
                                widths: [ ( QFinder.env.webkit ? 130 : 180 ) + 'px', ( QFinder.env.webkit ? 250 : 280 ) + 'px' ],
                                children: [
                                    {
                                        type: 'vbox',
                                        children: [
                                            {
                                                ...
                                                html: '' +
                                                    ...
                                                    'background-image: url("' + QFinder.getPluginPath('imageresize') + 'images/mini.gif");' +
                                                    'width: 16px;' +
                                                    'height: 16px;' +
                                            ...
                                            },
                                            {
                                                ...
                                                id: 'smallThumb',
                                                checked: false,
                                                label: api.lang.Imageresize.thumbnailSmall.replace('%s', QFinder.config.imageresize_thumbSmall)
                                            },
                                            {
                                                type: 'checkbox',
                                                id: 'mediumThumb',
                                                checked: false,
                                                label: api.lang.Imageresize.thumbnailMedium.replace('%s', QFinder.config.imageresize_thumbMedium)
                                            },
                                            {
                                                type: 'checkbox',
                                                id: 'largeThumb',
                                                checked: false,
                                                label: api.lang.Imageresize.thumbnailLarge.replace('%s', QFinder.config.imageresize_thumbLarge)
                                            }
                                        ]
                                    },
                                    {
                                                ...
                                                children: [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        onLoad: function () {
                                                            ...
                                                            if (resetButton) {
                                                                ...
                                                                resetButton.on('mouseover', function () {
                                                                    this.addClass('qf_btn_over');
                                                                }, resetButton);
                                                                resetButton.on('mouseout', function () {
                                                                    this.removeClass('qf_btn_over');
                                                                }, resetButton);
                                                            }
                                                        ...
                                                        html: '<div style="margin-top:4px">' +
                                                            '<a href="javascript:void(0)" tabindex="-1" title="' + api.lang.Imageresize.lockRatio + '" class="qf_btn_locked qf_btn_unlocked" id="btnLockSizes"></a>' +
                                                            '<a href="javascript:void(0)" tabindex="-1" title="' + api.lang.Imageresize.resetSize + '" class="qf_btn_reset" id="btnResetSize"></a>' +
                                                            '</div>'
                                                    }
                                                ]
                                            },

/**
 * @fileOverview Defines the {@link QFinder.lang} object for the Greek
 *		language.
 */
...
QFinder.lang['el'] =
{
	...
	500 : 'Ο πλοηγός αρχείων έχει απενεργοποιηθεί για λόγους ασφαλείας. Παρακαλούμε επικοινωνήστε με τον διαχειριστή της ιστοσελίδας και ελέγξτε το αρχείο ρυθμίσεων του πλοηγού (QFinder).',

...
class QFinder_Connector_Core_Hooks
{
        ...
        foreach ($hooks[$event] as $i => $hook) {
            ...
            */
            ...
            if (is_callable($callback)) {
                ...
                $errorHandler->throwError(QFINDER_CONNECTOR_ERROR_CUSTOM_ERROR,
                "QFinder failed to call a hook: " . $functionName);
                return false;
            }
            ...
            //no value returned
                ...
                $functionName = QFinder_Connector_Core_Hooks::_printCallback($callback);
                $errorHandler->throwError(QFINDER_CONNECTOR_ERROR_CUSTOM_ERROR,
                "QFinder extension returned an invalid value (null)." .

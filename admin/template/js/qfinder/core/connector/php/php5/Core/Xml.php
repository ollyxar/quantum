...
require_once QFINDER_CONNECTOR_LIB_DIR . "/Utils/XmlNode.php";

class QFinder_Connector_Core_Xml
{
    /**
     * Connector node (root)
     *
    ...
    function __construct()
    {
        ...
        $this->_connectorNode = new Qfinder_Connector_Utils_XmlNode("Connector");
        $this->_errorNode = new Qfinder_Connector_Utils_XmlNode("Error");
